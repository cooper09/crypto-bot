...
const init = async () => {
    ...
    const acctAddress = "0x3Ecdfe1Dad9Dc1aB0dB9e0bdE2F6E9D769efDB83";

    await web3.eth.getBalance(acctAddress, (err, wei) => {
        balance = web3.utils.fromWei(wei, 'ether');
        console.log("web3 - account balance: ", balance )
    });
    ...
    const contract = new web3.eth.Contract(daiABI, daiAddr);

    try {
        await contract.methods.name().call( (err,result) => {
            console.log("Dai available: ", result )
        }) } catch (e) {
